...
ROOT_DIR = Path(r"\\31\files\Documents\HLA_Laboratory_System")
...
DB_NAME = os.getenv("HLA_APP_DB_NAME", "hla_db")
...
# Учреждение по умолчанию в блоке «Сформировать заключение».
# Допустимые значения:
#   - "mnpc" — ГУ «МНПЦ ХТиГ»;
#   - "rnpc" — ГУ «РНПЦ ТиМБ».
DEFAULT_CONCLUSION_PLACE = "mnpc"
