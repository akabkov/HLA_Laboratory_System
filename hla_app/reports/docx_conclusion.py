...
def create_hla_conclusion_docx(
    ...
    *,
    ...
    if class1 is None and class2 is None:
        class1_to_render = {"hla_class": "I", "pra": "", "antibodies": []}
        class2_to_render = {"hla_class": "II", "pra": "", "antibodies": []}
    elif screening:
        if class1 is not None and class2 is None:
            class2_to_render = {"hla_class": "II", "pra": "", "antibodies": []}
        elif class1 is None and class2 is not None:
            class1_to_render = {"hla_class": "I", "pra": "", "antibodies": []}

    if class1_to_render is not None:
        add_class_block(doc, class1_to_render)

    if class2_to_render is not None:
        add_class_block(doc, class2_to_render)
    ...
    base_filename = f"{num_register}_АТ_{safe_last}_{initials}.docx"
