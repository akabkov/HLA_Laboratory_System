        ...
        if class1_selected and (test_dir / class1_file).is_file() and not delete_class1:
            conflicts.append(
                StudyImportConflict(
                    ...
                    reason="для замены файла сначала отметьте «Заменить Сlass I»",
        ...
        if class2_selected and (test_dir / class2_file).is_file() and not delete_class2:
            conflicts.append(
                StudyImportConflict(
                    ...
                    reason="для замены файла сначала отметьте «Заменить Сlass II»",
                ...
                if file_path.is_file():
                    conflicts.append(
                        StudyImportConflict(
                            file_name=file_name,
                            reason=(
                                "для замены заключения сначала отметьте "
                                "«Заменить заключение»"
                            ),
                            path=file_path,
                        )
            ...
            if source_class1_files:
                ...
                conflicts.append(
                    StudyImportConflict(
                        ...
                        reason=(
                            "для замены исходного файла в папке source_files "
                            "сначала отметьте «Заменить Class I»"
                        ),
                        path=source_class1,
                    )
                )
            ...
            if source_class2_files:
                ...
                conflicts.append(
                    StudyImportConflict(
                        ...
                        reason=(
                            "для замены исходного файла в папке source_files "
                            "сначала отметьте «Заменить Class II»"
                        ),
                        path=source_class2,
                    )
                )
