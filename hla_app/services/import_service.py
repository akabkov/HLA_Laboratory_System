...
def _upsert_patient(conn, patient: PatientData, inp: ImportInput) -> int:
...
def do_import(
    *, root_dir: Path, patient: PatientData, inp: ImportInput
    ...
    try:
        ...
        if inp.conclusion_jpg is not None:
        ...
        with get_engine().begin() as conn:
            ...
            if has_non_empty_tests:
                ...
                patient_id = _upsert_patient(conn, patient, inp)
