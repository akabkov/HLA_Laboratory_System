...
class MainWindow(QMainWindow):
    def __init__(self, *, root_dir_available: bool = True):
        ...
        form.addRow("Код реципиента:", self.recipient_code)
        ...
        self.clinic_group.addButton(self.rb_concl_mnpc)
        self.clinic_group.addButton(self.rb_concl_rnpc)
        ...
        self.rb_concl_mnpc.toggled.connect(
            lambda checked: self._on_concl_clinic_changed("mnpc", checked)
        )
        self.rb_concl_rnpc.toggled.connect(
            lambda checked: self._on_concl_clinic_changed("rnpc", checked)
        )
    ...
    def _apply_default_clinic_from_prefs(self) -> None:
        ...
        if clinic == "rnpc":
            self._set_button_checked_silently(self.rb_concl_mnpc, False)
            self._set_button_checked_silently(self.rb_concl_rnpc, True)
        else:
            self._set_button_checked_silently(self.rb_concl_rnpc, False)
            self._set_button_checked_silently(self.rb_concl_mnpc, True)
    ...
    def run_import(self):
        ...
        try:
            ...
            pure_delete_conclusion = (
                state.delete_conclusion and not state.has_conclusion_selection
            )
            ...
            if state.has_conclusion_selection and not state.has_csv_selection:
                assert self.conclusion_file_path is not None
    ...
    def _on_concl_clinic_changed(self, clinic: str, checked: bool) -> None:
        if not checked:
            return
    ...
    def _collect_conclusion_payload(self):
        ...
        from hla_app.services.conclusion_workflow import build_conclusion_payload
    ...
    def on_conclusion_save(self) -> None:
        ...
        try:
            from hla_app.services.conclusion_workflow import save_conclusion_docx
