...
# --- Валидатор частичного ввода числовых сегментов даты ---
...
# --- Переиспользуемый составной виджет ввода даты ---
...
class DateInput(QWidget):
    ...
    def set_date(self, d: date):
        blockers = (
            QSignalBlocker(self.dd),
            QSignalBlocker(self.mm),
            QSignalBlocker(self.yyyy),
        )
